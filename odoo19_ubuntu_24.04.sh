...
install_postgresql() {
    ...
    sudo apt-get update
    sudo apt-get install postgresql-17 postgresql-server-dev-17 postgresql-contrib-17 postgresql-17-postgis-3 -y
...
install_dependencies() {
    ...
    sudo apt install git python3 python3-pip build-essential wget python3-dev python3-venv python3-wheel python3-cffi libssl3 libxslt1-dev libzip-dev libldap2-dev libsasl2-dev libpq-dev libcairo2 libcairo2-dev pkg-config python3-setuptools python3-pyinotify libpng-dev libjpeg-dev gdebi -y
